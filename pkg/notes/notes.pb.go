...
func (c *notesClient) CreateNote(ctx context.Context, in *Note, opts ...grpc.CallOption) (*Note, error) {
	out := new(Note)
	err := grpc.Invoke(ctx, "/notes.Notes/createNote", in, out, c.cc, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *notesClient) DeleteNote(ctx context.Context, in *Note, opts ...grpc.CallOption) (*Note, error) {
	out := new(Note)
	err := grpc.Invoke(ctx, "/notes.Notes/deleteNote", in, out, c.cc, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *notesClient) UpdateNote(ctx context.Context, in *Note, opts ...grpc.CallOption) (*Note, error) {
	out := new(Note)
	err := grpc.Invoke(ctx, "/notes.Notes/updateNote", in, out, c.cc, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *notesClient) GetNotes(ctx context.Context, in *Query, opts ...grpc.CallOption) (*NoteList, error) {
	out := new(NoteList)
	err := grpc.Invoke(ctx, "/notes.Notes/getNotes", in, out, c.cc, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
