...
import (
	...
	"monocorpus/notes/api/pb"
	"monocorpus/notes/internal/endpoints"
	"monocorpus/notes/internal/service"
	"monocorpus/notes/internal/transport"
)

func main() {
	viper.AutomaticEnv()
	// viper.SetConfigName("notes")
	// viper.AddConfigPath("/home/matt/go/src/monocorpus/notes/configs")
